    ...
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                ...
                scm {
                    connection.set("scm:git@github.com:bmiller1009/simple-jndi-utils.git")
                    developerConnection.set("scm:git:ssh://github.com/simple-jndi-utils.git")
                    url.set("git@github.com:bmiller1009/simple-jndi-utils.git/")
                }
            }
